...
def upgrade_users():
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"name": "manager", "description": "Update data"},
            {"name": "admin", "description": "Add/change/delete users"},
        ],
    )

    #op.execute("INSERT INTO roles VALUES (1, 'member', 'Read only access')")
    #op.execute("INSERT INTO roles VALUES (2, 'manager', 'Update data')")
    #op.execute("INSERT INTO roles VALUES (3, 'admin', 'Add/change/delete users')")
